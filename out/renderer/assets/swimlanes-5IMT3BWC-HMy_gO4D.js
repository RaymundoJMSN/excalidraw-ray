const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./sizeCapture-X5ZJPWSS-DV7aYowJ.js","./index-D5Y8FJZj.js","./index-BcmKhzCI.js","./index-h46HQxgv.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./index-BcmKhzCI.js";
import { c as clear$2 } from "./chunk-RYQCIY6F-DmRwQKya.js";
import { am as markers_default, an as clear2, ao as clear, ap as clear$1, l as log, c as getConfig2, ag as insertNode, af as insertCluster, ah as positionNode, at as insertEdge, av as insertEdgeLabel, z as getConfig, as as getSubGraphTitleMargins, aw as edgeLabels, y as utils_default, ax as terminalLabels, _ as __name, ay as markerOffsets } from "./index-D5Y8FJZj.js";
...
async function createGraphWithElements(element, data4Layout) {
  ...
  if (globalThis.mermaidCaptureSizes) {
    const { captureNodeSizes } = await __vitePreload(async () => {
      const { captureNodeSizes: captureNodeSizes2 } = await import("./sizeCapture-X5ZJPWSS-DV7aYowJ.js");
